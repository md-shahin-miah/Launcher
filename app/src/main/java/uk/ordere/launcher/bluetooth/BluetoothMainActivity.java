package uk.ordere.launcher.bluetooth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPair.setOnClickListener(v -> {
            ...
            if (pairedDevices == null || pairedDevices.size() == 0) {
                ...
                Intent intent = new Intent(BluetoothMainActivity.this, DeviceListActivity.class);
...
//                mDeviceList.clear();
                ...
                Intent newIntent = new Intent(BluetoothMainActivity.this, DeviceListActivity.class);
    ...
    public void enableIndicator() {
        btConditionImage.setImageResource(R.drawable.ic_baseline_bluetooth_orange_24);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_CANCELED) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(BluetoothMainActivity.this);
